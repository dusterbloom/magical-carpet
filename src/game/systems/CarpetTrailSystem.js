...
export class CarpetTrailSystem {
  ...
  update(delta) {
    ...
    position.y -= 0.5; // Emit from bottom of carpet
    ...
    if (speed > 30 && this.timeSinceLastMotionLine > 1 / this.motionLineEmissionRate) {
  ...
  updateParticles(delta) {
    ...
    for (let i = this.trailParticles.length - 1; i >= 0; i--) {
      ...
      const scale = particle.userData.initialScale * (1 - lifeRatio * 0.7);
